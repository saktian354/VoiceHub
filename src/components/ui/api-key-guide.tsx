...
const providers = [
  {
    ...
    dashboardUrl: 'https://fish.audio/app/api-keys',
    steps: [
      'Buka website Fish Audio di fish.audio',
      'Klik "Sign Up" atau "Login" jika sudah punya akun (bisa juga di fish.audio/auth/signup)',
      'Setelah login, masuk ke halaman API Keys di fish.audio/app/api-keys',
      'Klik tombol "Create Secret Key"',
      'Beri nama untuk API Key Anda dan atur expiration (opsional)',
      'Klik "Create key" untuk konfirmasi',
